...
gender %>%
  ...
  mutate(Gender.Category.Coarse = case_when(GenderText=="female" ~ "woman",
                                     GenderText=="Female" ~ "woman",
                                     GenderText=="female " ~ "woman",
                                     GenderText=="cis male" ~ "man",
                                     GenderText=="male" ~ "man",
                                     GenderText=="Male" ~ "man",
                                     GenderText=="Female (cis)" ~ "woman",
                                     GenderText=="Woman" ~ "woman",
                                     GenderText=="woman" ~ "woman",
                                     GenderText=="Cis woman" ~ "woman",
                                     GenderText=="cis woman" ~ "woman",
                                     GenderText=="(cis)female" ~ "woman",
                                     GenderText=="cis female" ~ "woman",
                                     GenderText=="f" ~ "woman",
                                     GenderText=="she" ~ "woman",
                                     GenderText=="femile" ~ "woman",
                                     GenderText=="non-binary/gender non-conforming" ~ "nonbinary",
                                     GenderText=="Non-binary" ~ "nonbinary",
                                     GenderText=="Agender" ~ "nonbinary",
                                     GenderText=="agender" ~ "nonbinary",
                                     GenderText=="non-binary" ~ "nonbinary",
                                     GenderText=="non-binary lesbian" ~ "nonbinary",
                                     GenderText=="non binary/afab" ~ "nonbinary",
                                     GenderText=="gender agnostic" ~ "nonbinary",
                                     GenderText=="Non binary" ~ "nonbinary",
                                     GenderText=="Nonbinary" ~ "nonbinary",
                                     GenderText=="cis female / questioning nonbinary" ~ "other",
                                     GenderText=="non binary woman" ~ "other",
                                     GenderText=="femme" ~ "woman",
                                     TRUE ~ "other")) %>%
